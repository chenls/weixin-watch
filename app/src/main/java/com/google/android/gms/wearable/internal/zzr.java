...
implements Parcelable.Creator<ChannelReceiveFileResponse> {
    static void zza(ChannelReceiveFileResponse channelReceiveFileResponse, Parcel parcel, int n2) {
        n2 = zzb.zzav(parcel);
    ...
    public ChannelReceiveFileResponse zzih(Parcel parcel) {
        ...
        return new ChannelReceiveFileResponse(n4, n2);
    }

    public ChannelReceiveFileResponse[] zzlL(int n2) {
        return new ChannelReceiveFileResponse[n2];
    }
}
