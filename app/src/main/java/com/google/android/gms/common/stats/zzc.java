...
public final class zzc {
    public static zzlz<Integer> zzanx = zzlz.zza("gms:common:stats:max_num_of_events", 100);
    public static zzlz<Integer> zzany = zzlz.zza("gms:common:stats:max_chunk_size", 100);
    ...
    public static final class zza {
        ...
        static {
            zzanz = zzlz.zza("gms:common:stats:connections:level", zzd.LOG_LEVEL_OFF);
            ...
            zzanE = zzlz.zza("gms:common:stats:connections:time_out_duration", 600000L);
        }
    }
    ...
    public static final class zzb {
        ...
        static {
            zzanz = zzlz.zza("gms:common:stats:wakeLocks:level", zzd.LOG_LEVEL_OFF);
            zzanE = zzlz.zza("gms:common:stats:wakelocks:time_out_duration", 600000L);
        }
    }
}
