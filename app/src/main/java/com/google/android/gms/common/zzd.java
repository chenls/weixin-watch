...
class zzd {
    ...
    static abstract class zza {
         ...
         */
        protected zza(byte[] byArray) {
            boolean bl2 = byArray.length == 25;
            zzx.zzb(bl2, (Object)"cert hash data has incorrect length");
            this.zzafG = Arrays.hashCode(byArray);
        }

        protected static byte[] zzcs(String object) {
            try {
        ...
        public boolean equals(Object object) {
            if (object == null || !(object instanceof zza)) {
                return false;
            }
            object = (zza)object;
            return Arrays.equals(this.getBytes(), ((zza)object).getBytes());
        }
    ...
    extends zza {
        ...
        byte[] getBytes() {
            synchronized (this) {
                byte[] byArray;
                byte[] byArray2 = byArray = (byte[])this.zzafI.get();
                if (byArray == null) {
                    byArray2 = this.zzoL();
                    this.zzafI = new WeakReference<byte[]>(byArray2);
                }
                return byArray2;
            }
        }
