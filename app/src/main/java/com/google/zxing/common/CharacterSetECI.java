...
public enum CharacterSetECI {
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : CharacterSetECI.values()) {
            for (int n2 : characterSetECI.values) {
                VALUE_TO_ECI.put(n2, characterSetECI);
            }
    ...
    private CharacterSetECI(int n3) {
    ...
    public static CharacterSetECI getCharacterSetECIByValue(int n2) throws FormatException {
        if (n2 < 0 || n2 >= 900) {
