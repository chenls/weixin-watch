...
implements HttpStack {
    ...
    static HttpUriRequest createHttpRequest(Request<?> request, Map<String, String> object) throws AuthFailureError {
        switch (request.getMethod()) {
            ...
            case 1: {
                ...
                object.addHeader(HEADER_CONTENT_TYPE, request.getBodyContentType());
    ...
    private static void setEntityIfNonEmptyBody(HttpEntityEnclosingRequestBase httpEntityEnclosingRequestBase, Request<?> object) throws AuthFailureError {
        if ((object = (Object)((Request)object).getBody()) != null) {
            httpEntityEnclosingRequestBase.setEntity((HttpEntity)new ByteArrayEntity((byte[])object));
        }
    }
    ...
    @Override
    public HttpResponse performRequest(Request<?> request, Map<String, String> httpParams) throws IOException, AuthFailureError {
        HttpUriRequest httpUriRequest = HttpClientStack.createHttpRequest(request, httpParams);
        HttpClientStack.addHeaders(httpUriRequest, httpParams);
