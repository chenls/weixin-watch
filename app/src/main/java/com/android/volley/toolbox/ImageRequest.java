...
extends Request<Bitmap> {
    ...
    private Response<Bitmap> doParse(NetworkResponse networkResponse) {
        ...
        return Response.success(var6_4, HttpHeaderParser.parseCacheHeaders(networkResponse));
    }
    ...
    protected Response<Bitmap> parseNetworkResponse(NetworkResponse object) {
        ...
        synchronized (object2) {
            try {
                ...
                VolleyLog.e("Caught OOM for %d byte image, url=%s", ((NetworkResponse)object).data.length, this.getUrl());
