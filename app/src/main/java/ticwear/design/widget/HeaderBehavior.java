...
extends ViewOffsetBehavior<V> {
    ...
    boolean needSnapToZero() {
        return this.getTopBottomOffsetForScrollingSibling() + this.getOverScrollOffset() > 0;
    }
...
lbl30:
                ...
                while (true) {
                    if (this.mIsBeingDragged) {
                        ...
                        var1_1.pullEdgeEffects(0, var5_5);
                    }
                    ** GOTO lbl-1000
                    break;
                }
lbl37:
            ...
            case 1: {
                if (this.needSnapToZero() || this.mVelocityTracker == null) break;
                this.mVelocityTracker.addMovement(var3_3);
        ...
        this.snapToZeroOffsetIfNeeded(var1_1, var2_2);
        this.mIsBeingDragged = false;
        this.mActivePointerId = -1;
        if (this.mVelocityTracker != null) {
            this.mVelocityTracker.recycle();
        ...
        var1_1.releaseEdgeEffects();
        ** while (true)
    }

    final int scroll(CoordinatorLayout coordinatorLayout, V v2, int n2, int n3, int n4) {
        return this.setHeaderTopBottomOffset(coordinatorLayout, v2, this.getTopBottomOffsetForScrollingSibling() + this.getOverScrollOffset() - n2, n3, n4);
    }
    ...
    boolean snapToZeroOffsetIfNeeded(CoordinatorLayout coordinatorLayout, V v2) {
        return this.needSnapToZero();
    }
