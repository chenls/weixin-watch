...
class AndroidResources {
    ...
    static {
        styleable_VectorDrawableTypeArray = new int[]{0x1010003, 0x1010121, 0x1010155, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779};
        styleable_VectorDrawableGroup = new int[]{0x1010003, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867};
        styleable_VectorDrawablePath = new int[]{0x1010003, 0x1010404, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980};
        styleable_VectorDrawableClipPath = new int[]{0x1010003, 16843781};
        styleable_AnimatedVectorDrawable = new int[]{0x1010199};
        styleable_AnimatedVectorDrawableTarget = new int[]{0x1010003, 16843213};
    }
