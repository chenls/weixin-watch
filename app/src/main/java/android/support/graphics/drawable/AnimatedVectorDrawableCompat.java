...
implements Animatable {
    ...
    public static AnimatedVectorDrawableCompat create(@NonNull Context object, @DrawableRes int n2) {
        ...
        try {
            ...
            if (n2 == 2) return AnimatedVectorDrawableCompat.createFromXmlInner(object, object.getResources(), (XmlPullParser)resources, attributeSet, object.getTheme());
            ...
            if (n2 == 2) {
                ...
                if (ANIMATED_VECTOR.equals(string2)) {
                    ...
                    if (n2 != 0) {
                        ...
                        ((VectorDrawableCompat)((Object)object)).setAllowCaching(false);
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Drawable.Callback object, Resources resources) {
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (animatedVectorDrawableCompatState.mAnimators != null) {
                    ...
                    for (int i2 = 0; i2 < n2; ++i2) {
                        Animator animator2 = animatedVectorDrawableCompatState.mAnimators.get(i2);
                        context = animator2.clone();
                        String string2 = (String)animatedVectorDrawableCompatState.mTargetNameMap.get(animator2);
