    ...
    private void calculateUsingTextSize(float f2) {
        ...
        block14: {
            block13: {
                float f3;
                boolean bl2 = true;
                if (this.mText == null) break block13;
                boolean bl3 = false;
                boolean bl4 = false;
                ...
                bl3 = bl4;
                if (f2 > 0.0f) {
                    bl4 = this.mCurrentTextSize != f3 || this.mBoundsChanged || bl4;
                    this.mCurrentTextSize = f3;
                    this.mBoundsChanged = false;
                    bl3 = bl4;
                }
                if (this.mTextToDraw != null && !bl3) break block13;
                ...
                if (!TextUtils.equals((CharSequence)charSequence, (CharSequence)this.mTextToDraw)) break block14;
            }
            return;
        }
