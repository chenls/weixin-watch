...
public final class PrintHelper {
    ...
    implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String string2, Bitmap bitmap, final OnPrintFinishCallback onPrintFinishCallback) {
            ...
            ((PrintHelperKitkat)this.mPrintHelper).printBitmap(string2, bitmap, onPrintFinishCallback2);
        }
        ...
        public void printBitmap(String string2, Uri uri, final OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            ...
            ((PrintHelperKitkat)this.mPrintHelper).printBitmap(string2, uri, onPrintFinishCallback2);
        }

        @Override
        public void setColorMode(int n2) {
            ((PrintHelperKitkat)this.mPrintHelper).setColorMode(n2);
        }

        @Override
        public void setOrientation(int n2) {
            ((PrintHelperKitkat)this.mPrintHelper).setOrientation(n2);
        }

        @Override
        public void setScaleMode(int n2) {
            ((PrintHelperKitkat)this.mPrintHelper).setScaleMode(n2);
        }
    }
