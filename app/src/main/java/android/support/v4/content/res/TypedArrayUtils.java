...
public class TypedArrayUtils {
    ...
    public static boolean getBoolean(TypedArray typedArray, @StyleableRes int n2, @StyleableRes int n3, boolean bl2) {
    ...
    public static CharSequence[] getTextArray(TypedArray typedArray, @StyleableRes int n2, @StyleableRes int n3) {
        ...
        CharSequence[] charSequenceArray2 = charSequenceArray = typedArray.getTextArray(n2);
        if (charSequenceArray == null) {
            charSequenceArray2 = typedArray.getTextArray(n3);
        }
