...
extends DocumentFile {
    ...
    public DocumentFile[] listFiles() {
        Uri[] uriArray = DocumentsContractApi21.listFiles(this.mContext, this.mUri);
        DocumentFile[] documentFileArray = new DocumentFile[uriArray.length];
        for (int i2 = 0; i2 < uriArray.length; ++i2) {
            documentFileArray[i2] = new TreeDocumentFile(this, this.mContext, uriArray[i2]);
        }
