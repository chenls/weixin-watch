...
class AccessibilityNodeInfoCompatKitKat {
    ...
    public static CharSequence getRoleDescription(Object object) {
        return AccessibilityNodeInfoCompatKitKat.getExtras(object).getCharSequence(ROLE_DESCRIPTION_KEY);
    }

    private static long getTraits(Object object) {
        return AccessibilityNodeInfoCompatKitKat.getExtras(object).getLong(TRAITS_KEY, -1L);
    }
    ...
    public static Object obtainCollectionInfo(int n2, int n3, boolean bl2) {
    ...
    public static void setCanOpenPopup(Object object, boolean bl2) {
        ((AccessibilityNodeInfo)object).setCanOpenPopup(bl2);
    }
    ...
    public static void setDismissable(Object object, boolean bl2) {
        ((AccessibilityNodeInfo)object).setDismissable(bl2);
    }
    ...
    public static void setMultiLine(Object object, boolean bl2) {
        ((AccessibilityNodeInfo)object).setMultiLine(bl2);
    }
    ...
    public static void setRoleDescription(Object object, CharSequence charSequence) {
        AccessibilityNodeInfoCompatKitKat.getExtras(object).putCharSequence(ROLE_DESCRIPTION_KEY, charSequence);
    }

    private static void setTrait(Object object, long l2) {
        object = AccessibilityNodeInfoCompatKitKat.getExtras(object);
        object.putLong(TRAITS_KEY, object.getLong(TRAITS_KEY, 0L) | l2);
    }
