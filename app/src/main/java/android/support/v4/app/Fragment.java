...
View.OnCreateContextMenuListener {
    ...
    public static Fragment instantiate(Context object, String string2, @Nullable Bundle bundle) {
        try {
            Class<?> clazz;
            Class<?> clazz2 = clazz = sClassMap.get(string2);
            if (clazz == null) {
                clazz2 = object.getClassLoader().loadClass(string2);
                sClassMap.put(string2, clazz2);
            }
            object = (Fragment)clazz2.newInstance();
            if (bundle != null) {
                bundle.setClassLoader(object.getClass().getClassLoader());
                ((Fragment)object).mArguments = bundle;
            }
            return object;
        }
    ...
    static boolean isSupportFragmentClass(Context context, String string2) {
        ...
        try {
            Class<?> clazz2;
            clazz = clazz2 = sClassMap.get(string2);
            if (clazz2 != null) return Fragment.class.isAssignableFrom(clazz);
        }
        catch (ClassNotFoundException classNotFoundException) {
            return false;
        }
        clazz = context.getClassLoader().loadClass(string2);
        sClassMap.put(string2, clazz);
    ...
    public final String getString(@StringRes int n2, Object ... objectArray) {
    ...
    void performMultiWindowModeChanged(boolean bl2) {
    ...
    void performPictureInPictureModeChanged(boolean bl2) {
    ...
    public final void requestPermissions(@NonNull String[] stringArray, int n2) {
        if (this.mHost == null) {
            throw new IllegalStateException("Fragment " + this + " not attached to Activity");
        }
        this.mHost.onRequestPermissionsFromFragment(this, stringArray, n2);
    }
    ...
    public void setUserVisibleHint(boolean bl2) {
        if (!this.mUserVisibleHint && bl2 && this.mState < 4 && this.mFragmentManager != null && this.isAdded()) {
            this.mFragmentManager.performPendingDeferredStart(this);
        }
        this.mUserVisibleHint = bl2;
        bl2 = this.mState < 4 && !bl2;
