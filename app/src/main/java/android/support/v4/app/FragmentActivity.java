...
ActivityCompatApi23.RequestPermissionsRequestCodeValidator {
    ...
    private void dumpViewHierarchy(String string2, PrintWriter printWriter, View view) {
        ...
        if (view == null) {
            ...
            for (int i2 = 0; i2 < n2; ++i2) {
                this.dumpViewHierarchy(string2, printWriter, view.getChildAt(i2));
            }
        }
    }
    ...
    public void dump(String string2, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] stringArray) {
        ...
        this.mFragments.dumpLoaders(string3, fileDescriptor, printWriter, stringArray);
    ...
    protected void onActivityResult(int n2, int n3, Intent intent) {
        ...
        if (n4 != 0) {
            ...
            fragment.onActivityResult(0xFFFF & n2, n3, intent);
            return;
        }
     ...
     */
    @Override
    protected void onCreate(@Nullable Bundle stringArray) {
        Object object = null;
        ...
        if (stringArray != null) {
            Parcelable parcelable = stringArray.getParcelable(FRAGMENTS_TAG);
            FragmentController fragmentController = this.mFragments;
            if (nonConfigurationInstances != null) {
                object = nonConfigurationInstances.fragments;
            }
            fragmentController.restoreAllState(parcelable, (FragmentManagerNonConfig)object);
            if (stringArray.containsKey(NEXT_CANDIDATE_REQUEST_INDEX_TAG)) {
                this.mNextCandidateRequestIndex = stringArray.getInt(NEXT_CANDIDATE_REQUEST_INDEX_TAG);
                object = stringArray.getIntArray(ALLOCATED_REQUEST_INDICIES_TAG);
                stringArray = stringArray.getStringArray(REQUEST_FRAGMENT_WHO_TAG);
                if (object == null || stringArray == null || ((Object)object).length != stringArray.length) {
                    Log.w((String)TAG, (String)"Invalid requestCode mapping in savedInstanceState.");
                } else {
                    this.mPendingFragmentActivityResults = new SparseArrayCompat(((Object)object).length);
                    for (int i2 = 0; i2 < ((Object)object).length; ++i2) {
                        this.mPendingFragmentActivityResults.put((int)object[i2], stringArray[i2]);
                    }
                }
            }
        }
    ...
    public void onRequestPermissionsResult(int n2, @NonNull String[] stringArray, @NonNull int[] nArray) {
        ...
        block5: {
            block4: {
                ...
                string2 = this.mPendingFragmentActivityResults.get(--n3);
        ...
        fragment.onRequestPermissionsResult(n2 & 0xFFFF, stringArray, nArray);
    }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        Object object = this.mFragments.saveAllState();
        if (object != null) {
            bundle.putParcelable(FRAGMENTS_TAG, object);
        }
        if (this.mPendingFragmentActivityResults.size() > 0) {
            bundle.putInt(NEXT_CANDIDATE_REQUEST_INDEX_TAG, this.mNextCandidateRequestIndex);
            object = new int[this.mPendingFragmentActivityResults.size()];
            ...
            for (int i2 = 0; i2 < this.mPendingFragmentActivityResults.size(); ++i2) {
                object[i2] = (Parcelable)this.mPendingFragmentActivityResults.keyAt(i2);
                stringArray[i2] = this.mPendingFragmentActivityResults.valueAt(i2);
            }
            bundle.putIntArray(ALLOCATED_REQUEST_INDICIES_TAG, (int[])object);
            bundle.putStringArray(REQUEST_FRAGMENT_WHO_TAG, stringArray);
        }
    }
    ...
    void requestPermissionsFromFragment(Fragment fragment, String[] stringArray, int n2) {
        if (n2 == -1) {
            ActivityCompat.requestPermissions(this, stringArray, n2);
            return;
        }
        FragmentActivity.checkForValidRequestCode(n2);
        try {
            this.mRequestedPermissionsFromFragment = true;
            ActivityCompat.requestPermissions(this, stringArray, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n2));
            return;
        }
        finally {
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int n2, @Nullable Bundle bundle) {
        ...
        try {
            FragmentActivity.checkForValidRequestCode(n2);
            ActivityCompat.startActivityForResult(this, intent, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n2), bundle);
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intentSender, int n2, @Nullable Intent intent, int n3, int n4, int n5, Bundle bundle) throws IntentSender.SendIntentException {
        ...
        try {
            FragmentActivity.checkForValidRequestCode(n2);
            ActivityCompat.startIntentSenderForResult(this, intentSender, (this.allocateRequestIndex(fragment) + 1 << 16) + (0xFFFF & n2), intent, n3, n4, n5, bundle);
    ...
    extends FragmentHostCallback<FragmentActivity> {
        ...
        public void onDump(String string2, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] stringArray) {
            FragmentActivity.this.dump(string2, fileDescriptor, printWriter, stringArray);
        }
        ...
        @Override
        public void onRequestPermissionsFromFragment(@NonNull Fragment fragment, @NonNull String[] stringArray, int n2) {
            FragmentActivity.this.requestPermissionsFromFragment(fragment, stringArray, n2);
        }
