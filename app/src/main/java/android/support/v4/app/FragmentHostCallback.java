...
extends FragmentContainer {
     ...
     * Enabled aggressive block sorting
     */
    void doLoaderStop(boolean bl2) {
        this.mRetainLoaders = bl2;
    ...
    void dumpLoaders(String string2, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] stringArray) {
    ...
    void reportLoaderStart() {
        if (this.mAllLoaderManagers != null) {
            ...
            LoaderManagerImpl[] loaderManagerImplArray = new LoaderManagerImpl[n3];
            for (n2 = n3 - 1; n2 >= 0; --n2) {
                loaderManagerImplArray[n2] = (LoaderManagerImpl)this.mAllLoaderManagers.valueAt(n2);
            }
            for (n2 = 0; n2 < n3; ++n2) {
                LoaderManagerImpl loaderManagerImpl = loaderManagerImplArray[n2];
    ...
    SimpleArrayMap<String, LoaderManager> retainLoaderNonConfig() {
        ...
        if (this.mAllLoaderManagers != null) {
            ...
            LoaderManagerImpl[] loaderManagerImplArray = new LoaderManagerImpl[n5];
            for (n4 = n5 - 1; n4 >= 0; --n4) {
                loaderManagerImplArray[n4] = (LoaderManagerImpl)this.mAllLoaderManagers.valueAt(n4);
            }
            boolean bl2 = this.getRetainLoaders();
            n2 = 0;
            n4 = n3;
            n3 = n2;
            while (true) {
                n2 = n4;
                if (n3 >= n5) break;
                LoaderManagerImpl loaderManagerImpl = loaderManagerImplArray[n3];
                if (!loaderManagerImpl.mRetaining && bl2) {
