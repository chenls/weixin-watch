...
implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        while (true) {
            ...
            nArray = this.mOps;
            n3 = n4 + 1;
            nArray[n4] = op.enterAnim;
            nArray = this.mOps;
            n2 = n3 + 1;
            nArray[n3] = op.exitAnim;
            nArray = this.mOps;
            n3 = n2 + 1;
            nArray[n2] = op.popEnterAnim;
            nArray = this.mOps;
            int n5 = n3 + 1;
            nArray[n3] = op.popExitAnim;
            if (op.removed != null) {
        ...
        while (true) {
            ...
            if (n6 > 0) {
                ...
                while (true) {
                    ...
                    Fragment fragment = fragmentManagerImpl.mActive.get(this.mOps[n2]);
