...
public class ActivityOptionsCompat {
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity activity, Pair<View, String> ... pairArray) {
        if (Build.VERSION.SDK_INT >= 21) {
            View[] viewArray = null;
            String[] stringArray = null;
            if (pairArray != null) {
                View[] viewArray2 = new View[pairArray.length];
                String[] stringArray2 = new String[pairArray.length];
                int n2 = 0;
                while (true) {
                    stringArray = stringArray2;
                    viewArray = viewArray2;
                    if (n2 >= pairArray.length) break;
                    viewArray2[n2] = (View)pairArray[n2].first;
                    stringArray2[n2] = (String)pairArray[n2].second;
                    ++n2;
                }
            }
            if (Build.VERSION.SDK_INT >= 24) {
                return new ActivityOptionsImpl24(ActivityOptionsCompat24.makeSceneTransitionAnimation(activity, viewArray, stringArray));
            }
            if (Build.VERSION.SDK_INT >= 23) {
                return new ActivityOptionsImpl23(ActivityOptionsCompat23.makeSceneTransitionAnimation(activity, viewArray, stringArray));
            }
            return new ActivityOptionsImpl21(ActivityOptionsCompat21.makeSceneTransitionAnimation(activity, viewArray, stringArray));
        }
        return new ActivityOptionsCompat();
    }
