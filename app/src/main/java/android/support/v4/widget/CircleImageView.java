...
extends ImageView {
    ...
    CircleImageView(Context context, int n2) {
        ...
        if (this.elevationSupported()) {
            ...
            context.getPaint().setShadowLayer((float)this.mShadowRadius, (float)n4, (float)n3, 0x1E000000);
    ...
    extends OvalShape {
        ...
        private void updateRadialGradient(int n2) {
            ...
            this.mRadialGradient = new RadialGradient(f2, f3, f4, new int[]{0x3D000000, 0}, null, tileMode);
