...
extends Service {
    ...
    List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> list, Bundle object) {
        ...
        int n2 = object.getInt("android.media.browse.extra.PAGE", -1);
        int n3 = object.getInt("android.media.browse.extra.PAGE_SIZE", -1);
        if (n2 == -1) {
        ...
        Result<List<MediaBrowserCompat.MediaItem>> result = new Result<List<MediaBrowserCompat.MediaItem>>((Object)string2){
            ...
            void onResultSent(List<MediaBrowserCompat.MediaItem> list, int n2) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord.callbacks.asBinder()) != connectionRecord) {
                    if (DEBUG) {
                        Log.d((String)MediaBrowserServiceCompat.TAG, (String)("Not sending onLoadChildren result for connection that has been disconnected. pkg=" + connectionRecord.pkg + " id=" + string2));
                    }
                    return;
                }
                if ((n2 & 1) != 0) {
    ...
    MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public Bundle getBrowserRootHints() {
            block5: {
                block4: {
                    if (this.mMessenger == null) break block4;
                    if (MediaBrowserServiceCompat.this.mCurConnection == null) {
                        throw new IllegalStateException("This should be called inside of onLoadChildren or onLoadItem methods");
                    }
                    if (MediaBrowserServiceCompat.this.mCurConnection.rootHints != null) break block5;
                }
                return null;
            }
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String string2, int n2, Bundle object) {
            ...
            if (bundle2 == null) {
                string2 = ((BrowserRoot)object).getExtras();
                return new MediaBrowserServiceCompatApi21.BrowserRoot(((BrowserRoot)object).getRootId(), (Bundle)string2);
            }
            string2 = bundle2;
            if (((BrowserRoot)object).getExtras() == null) return new MediaBrowserServiceCompatApi21.BrowserRoot(((BrowserRoot)object).getRootId(), (Bundle)string2);
            bundle2.putAll(((BrowserRoot)object).getExtras());
            string2 = bundle2;
            return new MediaBrowserServiceCompatApi21.BrowserRoot(((BrowserRoot)object).getRootId(), (Bundle)string2);
        }
        ...
        public void getMediaItem(final String string2, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable(){
                ...
                public void run() {
                    Object object = serviceCallbacks.asBinder();
                    if ((object = (ConnectionRecord)MediaBrowserServiceCompat.this.mConnections.get(object)) == null) {
                        Log.w((String)MediaBrowserServiceCompat.TAG, (String)("getMediaItem for callback that isn't registered id=" + string2));
                        return;
                    }
        ...
        public void removeSubscription(final String string2, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable(){
                ...
                public void run() {
                    ...
                    ConnectionRecord connectionRecord = (ConnectionRecord)MediaBrowserServiceCompat.this.mConnections.get(iBinder2);
