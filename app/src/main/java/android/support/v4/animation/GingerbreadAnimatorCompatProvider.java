...
implements AnimatorProvider {
    ...
    implements ValueAnimatorCompat {
        ...
        public GingerbreadFloatValueAnimator() {
            this.mLoopRunnable = new Runnable(){
                ...
                public void run() {
                    ...
                    GingerbreadFloatValueAnimator.access$302(GingerbreadFloatValueAnimator.this, f2);
        ...
        static /* synthetic */ float access$302(GingerbreadFloatValueAnimator gingerbreadFloatValueAnimator, float f2) {
            gingerbreadFloatValueAnimator.mFraction = f2;
            return f2;
        }
