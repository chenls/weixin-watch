...
class TwilightCalculator {
    ...
    public void calculateTwilight(long l2, double d2, double d3) {
        ...
        double d4 = 1.796593063 + ((double)f3 + (double)0.0334196f * Math.sin(f3) + 3.4906598739326E-4 * Math.sin(2.0f * f3) + (double)5.236E-6f * Math.sin(3.0f * f3)) + Math.PI;
        d3 = -d3 / 360.0;
        ...
        f2 = (float)(Math.acos(d2) / (Math.PI * 2));
