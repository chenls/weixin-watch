...
public class AsyncListUtil<T> {
    ...
    public AsyncListUtil(Class<T> object, int n2, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>(){
            ...
            private boolean isRequestedGeneration(int n2) {
                return n2 == AsyncListUtil.this.mRequestedGeneration;
            }
            ...
            public void removeTile(int n2, int n3) {
                ...
                if (tile == null) {
                    Log.e((String)AsyncListUtil.TAG, (String)("tile not found @" + n3));
                    return;
                }
                AsyncListUtil.this.mBackgroundProxy.recycleTile(tile);
            }
            ...
            public void updateItemCount(int n2, int n3) {
                ...
                AsyncListUtil.access$002(AsyncListUtil.this, n3);
        ...
        this.mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>(){
             ...
             * Enabled aggressive block sorting
             */
            private void requestTiles(int n2, int n3, int n4, boolean bl2) {
                int n5 = n2;
                while (n5 <= n3) {
                    int n6 = bl2 ? n3 + n2 - n5 : n5;
    ...
    static /* synthetic */ int access$002(AsyncListUtil asyncListUtil, int n2) {
        asyncListUtil.mItemCount = n2;
        return n2;
    }

    static /* synthetic */ boolean access$102(AsyncListUtil asyncListUtil, boolean bl2) {
        asyncListUtil.mAllowScrollHints = bl2;
        return bl2;
    }
    ...
    public static abstract class DataCallback<T> {
        ...
        @WorkerThread
        public void recycleData(T[] TArray, int n2) {
        }
    ...
    public static abstract class ViewCallback {
         ...
         */
        @UiThread
        public void extendRangeInto(int[] nArray, int[] nArray2, int n2) {
