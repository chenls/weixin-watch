...
NestedScrollingParent {
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAddActionBarHideOffset = new Runnable(){
            ...
            public void run() {
                ActionBarOverlayLayout.this.haltActionBarHideOffsetAnimations();
                ActionBarOverlayLayout.access$002(ActionBarOverlayLayout.this, ViewCompat.animate((View)ActionBarOverlayLayout.this.mActionBarTop).translationY(-ActionBarOverlayLayout.this.mActionBarTop.getHeight()).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener));
            }
        };
        this.init(context);
    ...
    protected boolean fitSystemWindows(Rect rect) {
        ...
        boolean bl2 = this.applyInsets((View)this.mActionBarTop, rect, true, true, false, true);
    ...
    protected void onMeasure(int n2, int n3) {
        ...
        block7: {
            block6: {
                ...
                n8 = Math.max(0, this.mActionBarTop.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                n7 = Math.max(0, this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                n6 = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState((View)this.mActionBarTop));
                n5 = (ViewCompat.getWindowSystemUiVisibility((View)this) & 0x100) != 0 ? 1 : 0;
                if (n5 == 0) break block6;
                n9 = n4 = this.mActionBarHeight;
            ...
            if (this.mActionBarTop.getVisibility() != 8) {
                n9 = this.mActionBarTop.getMeasuredHeight();
            }
        }
        this.mContentInsets.set(this.mBaseContentInsets);
        this.mInnerInsets.set(this.mBaseInnerInsets);
        if (!this.mOverlayMode && n5 == 0) {
            layoutParams = this.mContentInsets;
            ((Rect)layoutParams).top += n9;
            layoutParams = this.mContentInsets;
        ...
        n9 = Math.max(n8, this.mContent.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
        n5 = Math.max(n7, this.mContent.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
        n4 = ViewUtils.combineMeasuredStates(n6, ViewCompat.getMeasuredState((View)this.mContent));
        n6 = this.getPaddingLeft();
        n7 = this.getPaddingRight();
        n5 = Math.max(n5 + (this.getPaddingTop() + this.getPaddingBottom()), this.getSuggestedMinimumHeight());
        this.setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(n9 + (n6 + n7), this.getSuggestedMinimumWidth()), n2, n4), ViewCompat.resolveSizeAndState(n5, n3, n4 << 16));
    }
