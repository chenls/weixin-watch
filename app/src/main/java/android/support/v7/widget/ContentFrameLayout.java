...
extends FrameLayout {
    ...
    protected void onMeasure(int n2, int n3) {
        ...
        if (n7 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n10 = n2;
                    if (n4 > 0) {
                        n10 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n4 - (this.mDecorPadding.left + this.mDecorPadding.right), View.MeasureSpec.getSize((int)n2)), (int)0x40000000);
                        n9 = 1;
                    }
                }
            }
        ...
        if (n8 == Integer.MIN_VALUE) {
            ...
            if (typedValue != null) {
                ...
                if (typedValue.type != 0) {
                    ...
                    n4 = n3;
                    if (n2 > 0) {
                        n4 = View.MeasureSpec.makeMeasureSpec((int)Math.min(n2 - (this.mDecorPadding.top + this.mDecorPadding.bottom), View.MeasureSpec.getSize((int)n3)), (int)0x40000000);
                    }
                }
            }
        }
        ...
        n10 = 0;
        n5 = View.MeasureSpec.makeMeasureSpec((int)n8, (int)0x40000000);
        n3 = n10;
        n2 = n5;
        if (n9 == 0) {
            n3 = n10;
            ...
            if (n7 == Integer.MIN_VALUE) {
                ...
                if (typedValue != null) {
                    ...
                    if (typedValue.type != 0) {
                        ...
                        n2 = n5;
                        if (n8 < n6) {
                            n2 = View.MeasureSpec.makeMeasureSpec((int)n6, (int)0x40000000);
                            n3 = 1;
                        }
                    }
                }
