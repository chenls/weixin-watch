...
extends RecyclerView.ItemAnimator {
    ...
    public final void dispatchChangeFinished(RecyclerView.ViewHolder viewHolder, boolean bl2) {
        this.onChangeFinished(viewHolder, bl2);
        this.dispatchAnimationFinished(viewHolder);
    }

    public final void dispatchChangeStarting(RecyclerView.ViewHolder viewHolder, boolean bl2) {
        this.onChangeStarting(viewHolder, bl2);
    }
    ...
    public void onChangeFinished(RecyclerView.ViewHolder viewHolder, boolean bl2) {
    }

    public void onChangeStarting(RecyclerView.ViewHolder viewHolder, boolean bl2) {
    }
