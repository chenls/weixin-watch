...
extends RecyclerView.LayoutManager {
    ...
    public StaggeredGridLayoutManager(int n2, int n3) {
        ...
        this.setAutoMeasureEnabled(bl2);
    ...
    private int calculateScrollDirectionForPosition(int n2) {
        ...
        boolean bl2 = n2 < this.getFirstChildPosition();
        if (bl2 == this.mShouldReverseLayout) return 1;
        return n3;
    }
    ...
    private boolean checkSpanForGap(Span span) {
        if (this.mShouldReverseLayout) {
            ...
            if (!span.getLayoutParams((View)((View)((Span)span).mViews.get((int)(((Span)span).mViews.size() - 1)))).mFullSpan) return true;
            return false;
        }
        if (span.getStartLine() <= this.mPrimaryOrientation.getStartAfterPadding()) return false;
        if (span.getLayoutParams((View)((View)((Span)span).mViews.get((int)0))).mFullSpan) return false;
        return true;
    }
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        View view = this.findFirstVisibleItemClosestToStart(bl3, true);
        bl3 = bl2;
        if (!this.mSmoothScrollbarEnabled) {
            bl3 = true;
        }
        return ScrollbarHelper.computeScrollExtent(state, orientationHelper, view, this.findFirstVisibleItemClosestToEnd(bl3, true), this, this.mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        return ScrollbarHelper.computeScrollOffset(state, orientationHelper, view, this.findFirstVisibleItemClosestToEnd(bl3, true), this, this.mSmoothScrollbarEnabled, this.mShouldReverseLayout);
    }
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        return ScrollbarHelper.computeScrollRange(state, orientationHelper, view, this.findFirstVisibleItemClosestToEnd(bl3, true), this, this.mSmoothScrollbarEnabled);
    }
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            block28: {
                block27: {
                    ...
                    n9 = layoutParams.getViewLayoutPosition();
                    n4 = this.mLazySpanLookup.getSpan(n9);
                    n8 = n4 == -1 ? 1 : 0;
                    if (n8 != 0) {
                        span = layoutParams.mFullSpan ? this.mSpans[0] : this.getNextSpan(layoutState);
                        this.mLazySpanLookup.setSpan(n9, span);
                    } else {
                        span = this.mSpans[n4];
                    }
                    ...
                    if (layoutState.mLayoutDirection != 1) break block27;
            ...
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (n8 != 0) {
                    ...
                    if (n4 != 0) {
                        fullSpanItem = this.mLazySpanLookup.getFullSpanItem(n9);
                        if (fullSpanItem != null) {
            ...
            if (this.isLayoutRTL() && this.mOrientation == 1) {
                ...
                n8 = n4 + this.mSecondaryOrientation.getDecoratedMeasurement(view);
            }
            if (this.mOrientation == 1) {
                this.layoutDecoratedWithMargins(view, n4, n6, n8, n5);
            } else {
                this.layoutDecoratedWithMargins(view, n6, n4, n5, n8);
            }
            if (layoutParams.mFullSpan) {
     ...
     * Enabled aggressive block sorting
     */
    private void fixEndGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean bl2) {
        int n2;
        block3: {
            block2: {
                n2 = this.getMaxEnd(Integer.MIN_VALUE);
                if (n2 == Integer.MIN_VALUE || (n2 = this.mPrimaryOrientation.getEndAfterPadding() - n2) <= 0) break block2;
     ...
     * Enabled aggressive block sorting
     */
    private void fixStartGap(RecyclerView.Recycler recycler, RecyclerView.State state, boolean bl2) {
        int n2;
        block3: {
            block2: {
                n2 = this.getMinStart(Integer.MAX_VALUE);
                if (n2 == Integer.MAX_VALUE || (n2 -= this.mPrimaryOrientation.getStartAfterPadding()) <= 0) break block2;
                n2 -= this.scrollBy(n2, recycler, state);
                if (bl2 && n2 > 0) break block3;
            }
            return;
    ...
    private Span getNextSpan(LayoutState object) {
        ...
        if (((LayoutState)object).mLayoutDirection == 1) {
            ...
            while (true) {
                ...
                object2 = this.mSpans[n4];
                int n7 = ((Span)object2).getEndLine(n6);
                int n8 = n5;
                if (n7 < n5) {
                    object = object2;
                    n8 = n7;
        ...
        while (n4 != n3) {
            object2 = this.mSpans[n4];
            int n11 = ((Span)object2).getStartLine(n10);
            int n12 = n9;
            if (n11 > n9) {
                object = object2;
                n12 = n11;
    ...
    private void handleUpdate(int n2, int n3, int n4) {
        ...
        if (n6 <= n7 || n5 > (n2 = this.mShouldReverseLayout ? this.getFirstChildPosition() : this.getLastChildPosition())) {
            return;
        }
        this.requestLayout();
    }

    private void layoutDecoratedWithMargins(View view, int n2, int n3, int n4, int n5) {
        LayoutParams layoutParams = (LayoutParams)view.getLayoutParams();
        this.layoutDecorated(view, n2 + layoutParams.leftMargin, n3 + layoutParams.topMargin, n4 - layoutParams.rightMargin, n5 - layoutParams.bottomMargin);
    }

    /*
     * Enabled aggressive block sorting
     */
    private void measureChildWithDecorationsAndMargin(View view, int n2, int n3, boolean bl2) {
        ...
        bl2 = bl2 ? this.shouldReMeasureChild(view, n2, n3, layoutParams) : this.shouldMeasureChild(view, n2, n3, layoutParams);
        if (bl2) {
            view.measure(n2, n3);
        }
    }

    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean bl2) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                this.measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, StaggeredGridLayoutManager.getChildMeasureSpec(this.getHeight(), this.getHeightMode(), 0, layoutParams.height, true), bl2);
                return;
            }
            this.measureChildWithDecorationsAndMargin(view, StaggeredGridLayoutManager.getChildMeasureSpec(this.getWidth(), this.getWidthMode(), 0, layoutParams.width, true), this.mFullSizeSpec, bl2);
            return;
        }
        if (this.mOrientation == 1) {
            this.measureChildWithDecorationsAndMargin(view, StaggeredGridLayoutManager.getChildMeasureSpec(this.mSizePerSpan, this.getWidthMode(), 0, layoutParams.width, false), StaggeredGridLayoutManager.getChildMeasureSpec(this.getHeight(), this.getHeightMode(), 0, layoutParams.height, true), bl2);
            return;
        }
        this.measureChildWithDecorationsAndMargin(view, StaggeredGridLayoutManager.getChildMeasureSpec(this.getWidth(), this.getWidthMode(), 0, layoutParams.width, true), StaggeredGridLayoutManager.getChildMeasureSpec(this.mSizePerSpan, this.getHeightMode(), 0, layoutParams.height, false), bl2);
    }
...
lbl10:
                                ...
                                while (true) {
                                    ...
                                    if (this.mPendingSavedState == null && (var8_5.mLayoutFromEnd != this.mLastLayoutFromEnd || this.isLayoutRTL() != this.mLastLayoutRTL)) {
                                        this.mLazySpanLookup.clear();
                    ...
                    if (!var8_5.mLayoutFromEnd) break block22;
...
lbl45:
                    ...
                    while (true) {
                        ...
                        if (this.getChildCount() > 0) {
                            if (!this.mShouldReverseLayout) break block20;
...
lbl51:
                        ...
                        while (true) {
                            ...
                            var4_6 = var5_7;
                            if (var2_2.isPreLayout()) ** GOTO lbl73
                            if (this.mGapStrategy == 0 || this.getChildCount() <= 0) break block21;
                            var5_7 = var6_4;
                            if (!this.mLaidOutInvalidFullSpan) {
                                if (this.hasGapsToFix() == null) break block21;
                                var5_7 = var6_4;
                            }
lbl63:
                            // 4 sources
...
lbl73:
    ...
    private boolean preferLastSpan(int n2) {
        if (this.mOrientation == 0) {
            boolean bl2 = n2 == -1;
            if (bl2 != this.mShouldReverseLayout) return true;
            return false;
        }
        boolean bl3 = n2 == -1;
        if ((bl3 = bl3 == this.mShouldReverseLayout) != this.isLayoutRTL()) return false;
        return true;
    }
    ...
    private void recycleFromEnd(RecyclerView.Recycler recycler, int n2) {
        View view;
        block0: for (int i2 = this.getChildCount() - 1; i2 >= 0 && this.mPrimaryOrientation.getDecoratedStart(view = this.getChildAt(i2)) >= n2; --i2) {
            LayoutParams layoutParams = (LayoutParams)view.getLayoutParams();
            if (layoutParams.mFullSpan) {
                int n3;
    ...
    private void recycleFromStart(RecyclerView.Recycler recycler, int n2) {
        View view;
        block0: while (this.getChildCount() > 0 && this.mPrimaryOrientation.getDecoratedEnd(view = this.getChildAt(0)) <= n2) {
            LayoutParams layoutParams = (LayoutParams)view.getLayoutParams();
            if (layoutParams.mFullSpan) {
                int n3;
                for (n3 = 0; n3 < this.mSpanCount; ++n3) {
    ...
    private void repositionToWrapContentIfNecessary() {
        if (this.mSecondaryOrientation.getMode() != 0x40000000) {
            ...
            n3 = n2 = Math.round((float)this.mSpanCount * f2);
            ...
            if (this.mSizePerSpan != n5) {
                for (n3 = 0; n3 < n4; ++n3) {
                    ...
                    if (this.mOrientation == 1) {
                        view.offsetLeftAndRight(n2 - n6);
                        continue;
                    }
                    view.offsetTopAndBottom(n2 - n6);
                }
            }
        }
    }
    ...
    private void updateLayoutState(int n2, RecyclerView.State object) {
        ...
        if (this.isSmoothScrolling()) {
            int n7 = ((RecyclerView.State)object).getTargetScrollPosition();
            n5 = n3;
            n6 = n4;
            if (n7 != -1) {
        ...
        bl2 = this.mPrimaryOrientation.getMode() == 0 && this.mPrimaryOrientation.getEnd() == 0 ? bl3 : false;
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] nArray) {
        int[] nArray2;
        if (nArray == null) {
            nArray2 = new int[this.mSpanCount];
        } else {
            nArray2 = nArray;
            if (nArray.length < this.mSpanCount) {
        ...
        while (n2 < this.mSpanCount) {
            nArray2[n2] = this.mSpans[n2].findFirstCompletelyVisibleItemPosition();
            ++n2;
        }
        return nArray2;
    }
     ...
     * Enabled aggressive block sorting
     */
    View findFirstVisibleItemClosestToEnd(boolean bl2, boolean bl3) {
     ...
     * Enabled aggressive block sorting
     */
    View findFirstVisibleItemClosestToStart(boolean bl2, boolean bl3) {
        int n2 = this.mPrimaryOrientation.getStartAfterPadding();
        int n3 = this.mPrimaryOrientation.getEndAfterPadding();
        int n4 = this.getChildCount();
        View view = null;
    ...
    public int[] findFirstVisibleItemPositions(int[] nArray) {
        ...
        int n2 = 0;
        while (n2 < this.mSpanCount) {
            nArray2[n2] = this.mSpans[n2].findFirstVisibleItemPosition();
            ++n2;
        }
        return nArray2;
    }
    ...
    public int[] findLastCompletelyVisibleItemPositions(int[] nArray) {
        ...
        int n2 = 0;
        while (n2 < this.mSpanCount) {
            nArray2[n2] = this.mSpans[n2].findLastCompletelyVisibleItemPosition();
            ++n2;
        }
        return nArray2;
    }
    ...
    public int[] findLastVisibleItemPositions(int[] nArray) {
        ...
        int n2 = 0;
        while (n2 < this.mSpanCount) {
            nArray2[n2] = this.mSpans[n2].findLastVisibleItemPosition();
            ++n2;
        }
        return nArray2;
    }
        ...
        while (true) {
            block14: {
                    ...
                    block17: {
                        block13: {
                            block15: {
                                ...
                                if (layoutParams.mFullSpan || n6 + n2 == n3) break block14;
                                view = this.getChildAt(n6 + n2);
                                n4 = 0;
                                if (!this.mShouldReverseLayout) break block15;
                                n7 = this.mPrimaryOrientation.getDecoratedEnd(view2);
                                if (n7 < (n8 = this.mPrimaryOrientation.getDecoratedEnd(view))) break block13;
                                if (n7 == n8) {
                                    n4 = 1;
                                }
                                break block16;
                            }
                            n7 = this.mPrimaryOrientation.getDecoratedStart(view2);
                            if (n7 <= (n8 = this.mPrimaryOrientation.getDecoratedStart(view))) break block17;
                        }
                        return view2;
                    }
                    if (n7 == n8) {
                ...
                if (n4 != 0) {
                    ...
                    n4 = layoutParams.mSpan.mIndex - layoutParams2.mSpan.mIndex < 0 ? 1 : 0;
                    if (n4 != (n7 = n5 < 0 ? 1 : 0)) {
                        return view2;
                    }
                }
    ...
    public View onFocusSearchFailed(View object, int n2, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        boolean bl2 = ((LayoutParams)object).mFullSpan;
        ...
        if (!bl2 && (recycler = ((Span)object).getFocusableViewAfter(n2, n3)) != null) {
            object = recycler;
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent object) {
        ...
        block5: {
            block4: {
                ...
                view2 = this.findFirstVisibleItemClosestToStart(false, true);
                view = this.findFirstVisibleItemClosestToEnd(false, true);
                if (view2 != null && view != null) break block5;
            }
            return;
        }
        int n3 = this.getPosition(view2);
        if (n3 < (n2 = this.getPosition(view))) {
            ((AccessibilityRecordCompat)object).setFromIndex(n3);
            ((AccessibilityRecordCompat)object).setToIndex(n2);
            return;
        }
        ((AccessibilityRecordCompat)object).setFromIndex(n2);
        ((AccessibilityRecordCompat)object).setToIndex(n3);
    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler object, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            ...
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(n2, n3, -1, -1, ((LayoutParams)object).mFullSpan, false));
            return;
        }
        int n4 = ((LayoutParams)((Object)object)).getSpanIndex();
        int n5 = ((LayoutParams)object).mFullSpan ? this.mSpanCount : 1;
        accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, n4, n5, ((LayoutParams)object).mFullSpan, false));
    }
    ...
    int scrollBy(int n2, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        this.mLayoutState.mAvailable = n3 = Math.abs(n2);
        n4 = this.fill(recycler, this.mLayoutState, state);
        if (n3 >= n4) {
            n2 = n2 < 0 ? -n4 : n4;
        }
        this.mPrimaryOrientation.offsetChildren(-n2);
    ...
    public void setGapStrategy(int n2) {
        ...
        boolean bl2 = this.mGapStrategy != 0;
        this.setAutoMeasureEnabled(bl2);
        this.requestLayout();
    }
    ...
    public void setReverseLayout(boolean bl2) {
        this.assertNotInLayoutOrScroll(null);
        if (this.mPendingSavedState != null && this.mPendingSavedState.mReverseLayout != bl2) {
            this.mPendingSavedState.mReverseLayout = bl2;
        }
    ...
    public void smoothScrollToPosition(RecyclerView object, RecyclerView.State state, int n2) {
        object = new LinearSmoothScroller(object.getContext()){
            ...
            public PointF computeScrollVectorForPosition(int n2) {
                if ((n2 = StaggeredGridLayoutManager.this.calculateScrollDirectionForPosition(n2)) == 0) {
                    return null;
                }
    ...
    static class LazySpanLookup {
                    ...
                    while (true) {
                        block6: {
                            block5: {
                                ...
                                if (this.mFullSpanItems.get((int)n6).mPosition < n2) break block6;
                                n3 = n6;
                            }
                            if (n3 == -1) break;
                            break block3;
         ...
         * Lifted jumps to return sites
         */
        public FullSpanItem getFirstFullSpanItemInRange(int n2, int n3, int n4, boolean bl2) {
            if (this.mFullSpanItems == null) {
                return null;
            }
            int n5 = this.mFullSpanItems.size();
    ...
    implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.mReverseLayout = bl3;
            bl3 = parcel.readInt() == 1;
            this.mAnchorLayoutFromEnd = bl3;
            bl3 = parcel.readInt() == 1 ? bl2 : false;
            this.mLastLayoutRTL = bl3;
    ...
    class Span {
         ...
         * Enabled aggressive block sorting
         */
        void cacheReferenceLineAndClear(boolean bl2, int n2) {
            int n3 = bl2 ? this.getEndLine(Integer.MIN_VALUE) : this.getStartLine(Integer.MIN_VALUE);
            this.clear();
            if (n3 == Integer.MIN_VALUE || bl2 && n3 < StaggeredGridLayoutManager.this.mPrimaryOrientation.getEndAfterPadding() || !bl2 && n3 > StaggeredGridLayoutManager.this.mPrimaryOrientation.getStartAfterPadding()) {
                return;
            }
            int n4 = n3;
            if (n2 != Integer.MIN_VALUE) {
         ...
         * Enabled aggressive block sorting
         */
        int findOneVisibleChild(int n2, int n3, boolean bl2) {
            int n4 = -1;
        ...
        public View getFocusableViewAfter(int n2, int n3) {
            ...
            if (n3 == -1) {
                ...
                while (true) {
                    ...
                    boolean bl2 = StaggeredGridLayoutManager.this.getPosition(view3) > n2;
                    view = view2;
                    if (bl2 != StaggeredGridLayoutManager.this.mReverseLayout) return view;
                    view2 = view3;
                    ++n3;
                }
            }
            ...
            while (true) {
                ...
                boolean bl3 = StaggeredGridLayoutManager.this.getPosition(view4) > n2;
                boolean bl4 = !StaggeredGridLayoutManager.this.mReverseLayout;
                view = view2;
