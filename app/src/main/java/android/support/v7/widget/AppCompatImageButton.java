...
implements TintableBackgroundView {
    ...
    public AppCompatImageButton(Context object, AttributeSet attributeSet, int n2) {
        ...
        this.mImageHelper = new AppCompatImageHelper((ImageView)this, (AppCompatDrawableManager)object);
