...
class ItemTouchUIUtilImpl {
    ...
    implements ItemTouchUIUtil {
        ...
        @Override
        public void onDraw(Canvas canvas, RecyclerView recyclerView, View view, float f2, float f3, int n2, boolean bl2) {
            if (n2 != 2) {
        ...
        @Override
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, View view, float f2, float f3, int n2, boolean bl2) {
            if (n2 == 2) {
                this.draw(canvas, recyclerView, view, f2, f3);
            }
        }
    ...
    extends Honeycomb {
        ...
        @Override
        public void onDraw(Canvas canvas, RecyclerView recyclerView, View view, float f2, float f3, int n2, boolean bl2) {
            if (bl2 && view.getTag(R.id.item_touch_helper_previous_elevation) == null) {
            ...
            super.onDraw(canvas, recyclerView, view, f2, f3, n2, bl2);
        }
    }
}
