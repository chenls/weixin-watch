...
public class TintTypedArray {
    ...
    public static TintTypedArray obtainStyledAttributes(Context context, AttributeSet attributeSet, int[] nArray, int n2, int n3) {
        return new TintTypedArray(context, context.obtainStyledAttributes(attributeSet, nArray, n2, n3));
    }
    ...
    public Drawable getDrawable(int n2) {
        ...
        if (this.mWrapped.hasValue(n2) && (n3 = this.mWrapped.getResourceId(n2, 0)) != 0) {
            return AppCompatDrawableManager.get().getDrawable(this.mContext, n3);
        }
