...
implements MenuItem {
    ...
    public void setExclusiveCheckable(boolean bl2) {
        try {
            ...
            this.mSetExclusiveCheckableMethod.invoke(this.mWrappedObject, bl2);
            return;
        }
    ...
    public MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener object) {
        ...
        SupportMenuItem supportMenuItem = (SupportMenuItem)this.mWrappedObject;
        if (object != null) {
            OnActionExpandListenerWrapper onActionExpandListenerWrapper = new OnActionExpandListenerWrapper((MenuItem.OnActionExpandListener)object);
        } else {
            Object var1_4 = null;
        }
        supportMenuItem.setSupportOnActionExpandListener((MenuItemCompat.OnActionExpandListener)var1_3);
        return this;
    }
