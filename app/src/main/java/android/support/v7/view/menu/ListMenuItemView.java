...
implements MenuView.ItemView {
    ...
    public void setIcon(Drawable drawable2) {
        block7: {
            block6: {
                ...
                if (!bl2 && !this.mPreserveIconSpacing || this.mIconView == null && drawable2 == null && !this.mPreserveIconSpacing) break block6;
    ...
    public void setShortcut(boolean bl2, char c2) {
        c2 = bl2 && this.mItemData.shouldShowShortcut() ? (char)'\u0000' : (char)8;
        if (c2 == '\u0000') {
